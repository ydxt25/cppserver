...
void ClientSocket::handle_read(boost::system::error_code ec,size_t byte_transferred)
{
    if(!ec)
    {
        cout<<message;
...
void ClientSocket::handle_write(boost::system::error_code ec,size_t byte_transferred)
{
    cout<<"sended"<<endl;
}
